...
?>
<h1 class="pt-3 text-center itemText2">Achievement Diaries</h1>
<h3 class="pt-3 text-center itemText2">Click below to jump to selected achievement diary.</h3>
...
<li class="list-group-item" onclick="scrollToElement('kourendDiary');">Kourend Diary</li>
	...
	<div class="col-12 col-sm-12 col-md-12 col-lg-12 mt-5 pb-3 text-left blueBg border border-dark">
			<div class="row">
				<div class ="col-lg-10 offset-lg-1 col-md-10 offset-md-1 col-sm-12 offset-sm-0 col-12 offset-0 pb-0">
					<h2 class="pt-3 text-center itemText2">Achievement Diary Rewards</h2>
...
<div class="container-fluid text-center">
	<div class="col-12 col-sm-12 col-md-12 col-lg-12 pb-3 mt-5 text-left blueBg border border-dark">

		<h1 class="text-center itemText2 pt-3">Select from the list below to view steps.</h1>

		<ul class="list-group list-group-flush">

		<h3 id="ardougneDiary" class="itemText2 pt-5">Ardougne</h3>
		...
		<h3 id="desertDiary" class="itemText2 pt-5">Desert</h3>
		...
		<h3 id="faladorDiary" class="itemText2 pt-5">Falador</h3>
		...
		<h3 id="fremennikDiary" class="itemText2 pt-5">Fremennik</h3>
		...
		<h3 id ="kandarinDiary" class="itemText2 pt-5">Kandarin</h3>
		...
		<h3 id="karamjaDiary" class="itemText2 pt-5">Karamja</h3>
		...
		<h3 id="lumbridgeDiary" class="itemText2 pt-5">Lumbridge & Draynor</h3>
		...
		<h3 id="morytaniaDiary" class="itemText2 pt-5">Morytania</h3>
		...
		<h3 id="westernDiary" class="itemText2 pt-5">Western Provinces</h3>
		...
		<h3 id="varrockDiary" class="itemText2 pt-5">Varrock</h3>
		...
		<h3 id="wildernessDiary" class="itemText2 pt-5">Wilderness</h3>
		...
		<h3 id="kourendDiary" class="itemText2 pt-5">Kebos (Kourend)</h3>
