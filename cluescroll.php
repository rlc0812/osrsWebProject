...
<div class="collapse navbar-collapse" id="navbarMobile">
		...
		<li class="nav-item active" id="cluescrollNav">
...
<h1 class="pt-1 text-center itemText2">Cluescroll Requirement Calculator</h1>
</div>
</div>
<?php
if(isset($_SESSION['u_userID'])){
...
<h3 class="itemText2">Cluescroll Skill Requirements</h3>
        <div class="row">
...
<div class="container-fluid p-5 text-center">
	<h3 class="itemText2">Sherlock Step Requirements</h3>
	<div class="row">
        <div class="col-xl-6 offset-xl-3 col-lg-6 offset-lg-3 col-md-8 offset-md-2 col-sm-12 col-xs-12">
			<ul class="list-group list-group-flush">
