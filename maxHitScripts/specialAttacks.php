<?php
	...
	$specialAttack['Dragon dagger(p)']=$spec;
	$specialAttack['Dragon dagger(p+)']=$spec;
	$specialAttack['Dragon dagger(p++)']=$spec;
	...
	$specialAttack['Dragon hasta(p)']=$spec;
	$specialAttack['Dragon hasta(p+)']=$spec;
	$specialAttack['Dragon hasta(p++)']=$spec;
	...
	$specialAttack['Armadyl godsword (or)']=$spec;
	...
	$specialAttack['Bandos godsword (or)']=$spec;
	...
	$specialAttack['Saradomin godsword (or)']=$spec;
	...
	$specialAttack['Zamorak godsword (or)']=$spec;
	...
	$specialAttack['Abyssal dagger (p)']=$spec;
	$specialAttack['Abyssal dagger (p+)']=$spec;
	$specialAttack['Abyssal dagger (p++)']=$spec;
	...
	$specialAttack['Bone dagger (p)']=$spec;
	$specialAttack['Bone dagger (p+)']=$spec;
	$specialAttack['Bone dagger (p++)']=$spec;
	...
	$specialAttack["Sara's blessed sword (full)"]=$spec;
